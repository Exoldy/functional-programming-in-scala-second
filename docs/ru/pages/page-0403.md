...
### (продолжение) Полиморфные типы функций

Полиморфные типы функций — это как cheat code для полиморфных методов: ссылаемся на них, не теряя параметры типов, без этой хуйни с выбором конкретики для каждого. Но Scala, сука, не телепат — не выведет полиморфный тип функции при eta-расширении, приходится пинать явно:
